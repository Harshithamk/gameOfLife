...
public class BoardTest {
    ...
    public void shouldInitializeBoardWithGivenCellState() {
        ...
        Board board = new Board(3, 3, Arrays.asList(coordinate, coordinate1, coordinate2, coordinate3));
    ...
    public void shouldGetNextGeneration() {
        ...
        Board board = new Board(3, 3, Arrays.asList(coordinate, coordinate1, coordinate2));
    ...
    @Test
    public void get2AsNeighborsAliveCountOfCell(){
        Coordinate coordinate = new Coordinate(1, 1);
        Coordinate coordinate1 = new Coordinate(1, 0);
        Coordinate coordinate2 = new Coordinate(1, 2);
        ...
        Cell cell1 = new Cell(new Coordinate(1, 1), Status.ALIVE);
